...
public class ProdusController : ControllerBase
{
    ...
    public ProdusController(AppDbContext db)
    {
        _db = db;
    }

    [HttpGet]
    public ActionResult<List<ProdusEntity>> GetProduseHardcodat()
    {
        var lista = new List<ProdusEntity>
        {
            new ProdusEntity { IdProdus = 1, NumeProdus = "mere" },
            new ProdusEntity { IdProdus = 2, NumeProdus = "pere" },
            new ProdusEntity { IdProdus = 3, NumeProdus = "struguri" }
        };
        return Ok(lista);
    }
